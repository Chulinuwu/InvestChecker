		...
		{:else}
			...
			<div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200" transition:fade>
				...
				<div class="grid gap-6 md:grid-cols-2">
					...
					>
						...
						<div class="relative">
							<span
								class="absolute left-4 top-1/2 -translate-y-1/2 text-lg font-bold text-indigo-300"
								>฿</span
							>
							<input
								type="number"
			...
			<div class="mt-6 rounded-xl border border-slate-200 bg-white p-4">
				<div class="flex gap-3">
					<div
						class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-slate-50"
					>
						<svg
							class="h-4 w-4 text-slate-400"
							fill="none"
